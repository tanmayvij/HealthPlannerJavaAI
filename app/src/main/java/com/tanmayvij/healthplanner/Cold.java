...
public class Cold extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.FontSize(20);
    Label2.Text("Viral infection of the upper respiratory tract. Most commonly implicated virus: rhinovirus");
