...
public class Cataract extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.FontSize(20);
    Label2.Text("Most cataracts develop when aging or injury changes the tissue that makes up your eye's lens.");
    ...
    Label6.FontSize(20);
    Label6.Text("* Dark Leafy Green Foods");
