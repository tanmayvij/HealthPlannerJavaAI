...
public class z110001 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.FontSize(20);
    Label2.Text("Connaught Place, Janpath, Pragati Maidan, Parliament House, Supreme Court, Shastri Bhawan, Rail Bhawan, Patiala House.");
    ...
    Label4.FontSize(20);
    Label4.Text("Dr Ram Manohar Lohia Hospital +91-11-23365525, 23348200");
    Label4.TextColor(0xFFFFFFFF);
    Label5 = new Label(this);
    Label5.FontSize(20);
    Label5.Text("Sucheta Kriplani Hospital +91-11-23408100, 23363778");
    Label5.TextColor(0xFFFFFFFF);
    Label6 = new Label(this);
    Label6.FontSize(20);
    Label6.Text("Kalawati Saran Hospital +91-11-23365792, 23344147");
