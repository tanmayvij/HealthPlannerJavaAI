...
public class z110017 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.FontSize(20);
    Label2.Text("Saket, Malviya Nagar, Pushpa Vihar, Panchsheel Enclave");
    ...
    Label4.FontSize(20);
    Label4.Text("Vardaan Hospital +91-11-33723171");
    Label4.TextColor(0xFFFFFFFF);
    Label5 = new Label(this);
    Label5.FontSize(20);
    Label5.Text("Max Super Speciality Hospital +91-11-39510688");
    Label5.TextColor(0xFFFFFFFF);
    Label6 = new Label(this);
    Label6.FontSize(20);
    Label6.Text("Saket City Hospital +91-11-71212121, 40699999");
