...
public class Fever extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.FontSize(20);
    Label2.Text("Viral, bacterial & parasitic infections.");
