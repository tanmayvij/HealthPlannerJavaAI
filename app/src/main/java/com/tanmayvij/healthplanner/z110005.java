...
public class z110005 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label4.FontSize(20);
    Label4.Text("BLK Super Speciality Hospital +91-11-30403040");
    Label4.TextColor(0xFFFFFFFF);
    Label5 = new Label(this);
    Label5.FontSize(20);
    Label5.Text("Harnam Singh Charitable Medical Centre +91-11-25723976");
    Label5.TextColor(0xFFFFFFFF);
    Label6 = new Label(this);
    Label6.FontSize(20);
    Label6.Text("Sir Ganga Ram Hospital +91-11-45099999");
    Label6.TextColor(0xFFFFFFFF);
    Label7 = new Label(this);
    Label7.FontSize(20);
    Label7.Text("Jeewan Nursing Home & Hospital +91-11-42430246");
