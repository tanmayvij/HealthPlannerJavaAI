...
public class z110034 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.FontSize(20);
    Label2.Text("Pitampura, Netaji Subhash Place");
    ...
    Label4.FontSize(20);
    Label4.Text("Max Hospital +91-11-33631600");
    Label4.TextColor(0xFFFFFFFF);
    Label5 = new Label(this);
    Label5.FontSize(20);
    Label5.Text("Vasan Eye Care Hospital +91-11-39890600, +91-8860629269");
    Label5.TextColor(0xFFFFFFFF);
    Label6 = new Label(this);
    Label6.FontSize(20);
    Label6.Text("Bhagwan Mahavir Hospital +91-11-27033947, 27034537");
    Label6.TextColor(0xFFFFFFFF);
    Label7 = new Label(this);
    Label7.FontSize(20);
    Label7.Text("Kuber Hospital +91-11-27352931, 27353246");
