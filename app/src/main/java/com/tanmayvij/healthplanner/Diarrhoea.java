...
public class Diarrhoea extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.FontSize(20);
    Label2.Text("* Viruses such as norovirus or rotavirus.");
    Label2.TextColor(0xFFFFFFFF);
    Label3 = new Label(this);
    Label3.FontSize(20);
    Label3.Text("* Bacteria, such as campylobacter.");
