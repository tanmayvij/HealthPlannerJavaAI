...
public class z110087 extends Form implements HandlesEventDispatching {
  ...
  protected void $define() {
    ...
    Label2.FontSize(20);
    Label2.Text("Meera Bagh, Sunder Vihar");
    ...
    Label4.FontSize(20);
    Label4.Text("Bhatia Global Hospital +91-11-25270702");
    Label4.TextColor(0xFFFFFFFF);
    Label5 = new Label(this);
    Label5.FontSize(20);
    Label5.Text("Kalawathi Kaustubh Hospital Pvt. Ltd +91-11-25257540");
    Label5.TextColor(0xFFFFFFFF);
    Label6 = new Label(this);
    Label6.FontSize(20);
    Label6.Text("Sehgal Neo Hospital +91-11-45565656");
    Label6.TextColor(0xFFFFFFFF);
    Label7 = new Label(this);
    Label7.FontSize(20);
    Label7.Text("Jainar Hospital +91-11-25267056");
